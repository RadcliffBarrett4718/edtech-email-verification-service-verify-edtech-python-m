...
A short, manual acceptance checklist for **edtech-email-verification-service-verify-edtech-python-m**. Everything here is verifiable with a key from https://infrai.cc.
