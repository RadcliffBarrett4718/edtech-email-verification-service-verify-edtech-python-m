...
> Design notes for **edtech-email-verification-service-verify-edtech-python-m** — a runnable python example that Typed Python signup service for learner verification, course deadlines, and educator reporting.
...
- **Feature code** — the actual task: edtech-email-verification.
